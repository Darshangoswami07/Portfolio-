...
export function ChatHeader({ selectedConversationId, onNewChat, onClose }: ChatHeaderProps) {
  ...
  return (
    <motion.div
      ...
      className="flex items-center justify-between px-5 py-4 backdrop-blur border-b border-white/20 dark:border-slate-800/20 bg-indigo-500/20"
    >
      <div className="flex items-center space-x-4">
        ...
        <div>
          <div className="font-semibold text-foreground">Darshan AI Assistant</div>
