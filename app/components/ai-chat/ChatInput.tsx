    ...
    <form suppressHydrationWarning onSubmit={handleSubmit} className="flex flex-col space-y-2 p-4 bg-muted-background/50 border-t border-muted-background/50">
      <div className="flex items-center space-x-3">
        ...
        <textarea
          ...
          disabled={isLoading}
          className="flex-1 min-h-11 resize-none rounded-border px-3 py-2 bg-muted-background/50 text-foreground/90 placeholder:text-muted-foreground/50 focus:ring-2 focus:ring-primary focus:ring-offset-0"
          rows={1}
        />
