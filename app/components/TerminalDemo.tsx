    ...
    'darshan': {
      'projects': {
        'yash': {
          ...
          'portfolio': {
          'package.json': '{ "name": "darshan-portfolio", "version": "1.0.0" }',
          'README.md': '# Darshan Portfolio\nBuilt with Next.js and Tailwind CSS.',
        },
      },
...
export default function TerminalDemo() {
  ...
  const [cwd, setCwd] = useState('/home/darshan/projects/yash');
