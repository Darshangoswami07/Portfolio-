      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            {' '}Passionate Full Stack MERN Developer skilled in React.js, Node.js, Express.js, MongoDB, and modern web technologies.
          </motion.p>
          ...
          <motion.div
            ...
            <button
              ...
              className="px-8 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-all duration-200 transform hover:scale-105"
            >
              View Projects
            </button>
            <button
            ...
            <button
              ...
              className="px-6 py-3 bg-indigo-500 text-white rounded-lg font-semibold hover:bg-indigo-600 transition-all duration-200 transform hover:scale-105"
            >
              Chat with assistant
            </button>
          </motion.div>
