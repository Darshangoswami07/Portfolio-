...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'darshangirigoswami07@gmail.com',
    href: 'mailto:darshangirigoswami07@gmail.com'
  },
  {
    icon: Phone,
    label: 'Phone',
    value: '+91 8865928963',
    href: 'tel:+918865928963'
  },
  {
    icon: MapPin,
    label: 'Location',
...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:darshangirigoswami07@gmail.com?subject=${subject}&body=${body}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-6 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
